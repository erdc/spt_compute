...
from ..imports.helper_functions import get_date_timestep_from_forecast_folder
...
# TODO: Wait to submit next forecast until previous job is finished, keep downloading if not ready to submit
                ...
                for ecmwf_folder in ecmwf_folders:
                    ...
                    try:
                        ...
                        for region_data in region_data_list:
                            job_info = subprocess.check_output(['qsub',
